...
<div
	...
	<div class="h-full flex items-center">
		...
		<div class="search hidden sm:block" style="margin-right: 20px;">
		    <input type="text" id="web_output" class="search__input form-control border-transparent" style="background-color: #FFFFFF" placeholder="Search...">
...
<nav class="top-nav text-xl">
	<ul>
		<li class="top_menu"><a id="ai" href="/mem/ai/doran"
			class="top-menu">
